...
TextStyle blackTexStyle = GoogleFonts.poppins(color: blackColor);
TextStyle whiteTexStyle = GoogleFonts.poppins(color: whiteColor);
TextStyle greyTexStyle = GoogleFonts.poppins(color: greyColor);
TextStyle blueTexStyle = GoogleFonts.poppins(color: blueColor);
TextStyle greenTexStyle = GoogleFonts.poppins(color: greenColor);
